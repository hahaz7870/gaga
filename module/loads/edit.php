...
<form action="/loads/edit/id/'.$param['id'].'" method="POST" enctype="multipart/form-data">
        <input type="text" id="name" name="name" required placeholder="Название материала" value="'.$Row['name'].'">
        ...
        <label for="file" class="file-upload-label">Выберите файл (zip)</label>
        <input type="file" name="file" id="file" class="file-upload-btn" >
        <label for="img" class="file-upload-label">Выберите изображение</label>
        <input type="file" name="img" id="img" class="file-upload-btn" >
        </div>
        <textarea name="text" required placeholder="Текст материала">'.$Row['text'].'</textarea>
